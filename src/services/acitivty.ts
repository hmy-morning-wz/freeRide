...
///http://sit-operation.allcitygo.com:80/operation-activity/double11Game/getIndustryVoucher 气泡任务
 ...
 sendVoucher(_: any, { userId }: any): ServiceRequestData {
   ...
   // /sendRedBag POST /preheatRedBag/redBagsend
     sendRedBag({sharerId,sellerId,nickname,limitCount,switchFlag,redBagId}: any, { userId }: any): ServiceRequestData {
 
      return {
         url: '/preheatRedBag/redBagsend',
         method: "POST",
